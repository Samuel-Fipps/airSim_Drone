...
class CustomEvalCallback(EvalCallback):
    ...
    def _on_step(self) -> bool:
        ...
        if self.n_calls % self.eval_freq == 0:
            ...
            latest_lengths = self.eval_env.get_attr('episode_lengths')[-1]
...
loaded_model = PPO.load("D:/Everything/PPO-based-Autonomous-Navigation-for-Quadcopters/best_model_2") # first: 5, second: 5, third: 0
